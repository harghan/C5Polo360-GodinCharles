...
<?php  if(!$success) { ?>
	<form enctype="multipart/form-data" id="baseCrmFormView<?php  echo intval($bID)?>" class="baseCrmFormView" method="post"
		...
		<fieldset>
			...
			<input type="text" name="first_name" value="<?php  echo $fields['first_name'];?>" placeholder="<?php  echo t('First name'); ?>"><br>

			<label for="last_name"><?php  echo t('Last name'); ?></label>
			<input type="text" name="last_name" value="<?php  echo $fields['last_name'];?>" placeholder="<?php  echo t('Last name'); ?>"><br>

			<label for="email"><?php  echo t('E-mail'); ?></label>
			<input type="email" name="email" value="<?php  echo $fields['email'];?>" placeholder="<?php  echo t('E-mail'); ?>"><br>

			<label for="mobile"><?php  echo t('Mobile number'); ?></label>
			<input type="tel" name="mobile" value="<?php  echo $fields['mobile'];?>" placeholder="<?php  echo t('Mobile number'); ?>"><br>

			<label for="message"><?php  echo t('Message'); ?></label>
			<textarea name="message" value="<?php  echo $fields['message'];?>" placeholder="<?php  echo t('Message'); ?>"></textarea><br>
